...
SECRET_KEY = 'django-insecure-%*we_b_alzfr)2d*@238n&&s!ypfmm5m4h5w@tl3^dm^ak0f4w'
...
DATABASES = {
    'default': {
        ...
        'NAME': get_env_value('DB_NAME', 'magazine'),
        'USER': get_env_value('DB_USER', 'magazine'),
        'PASSWORD': get_env_value('DB_PASSWORD', 'magazine'),
